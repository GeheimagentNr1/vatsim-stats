...
public interface PilotTrackPointRepository extends JpaRepository<PilotTrackPoint, Long> {
    ...
    /**
     * Like {@link #findTopByCidAndCallsignAndLogonTimeOrderByRecordedAtDesc}, but bounded to track
     * points recorded at or after {@code recordedAtFrom}. {@code pilot_track_point} has no
